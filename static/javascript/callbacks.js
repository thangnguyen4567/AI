...
let apiMainPathSample = '/english/';// 'http://127.0.0.1:3001';// 'https://a3hj0l2j2m.execute-api.eu-central-1.amazonaws.com/Prod';
let apiMainPathSTS = '/english/';// 'https://wrg7ayuv7i.execute-api.eu-central-1.amazonaws.com/Prod';
            ...
            try {
                await fetch(apiMainPathSTS + '/GetAccuracyFromRecordedAudio', {
                    ...
                    then(async data => {
                        ...
                        await fetch("/chatbot/conversations", {
                            method: "POST",
                            headers: {
                            ...
                            then(data => {
                                document.getElementById("ai_feedback").innerHTML = data.answer
                            })
                    });
            }
            catch {
