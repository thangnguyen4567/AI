...
class GoalDetail(BaseModel):
    ...
    Unit: str = Field(description="Đơn vị ('currency' : tiền, 'percent' : phần trăm, 'number' : số lượng)")
    ...
    Type: str = Field(description="Loại mục tiêu 'Tài chính', 'Khách hàng', 'Nội bộ', 'Sản phẩm', 'Quy trình', 'Khác', 'Đào tạo & Phát triển'")
